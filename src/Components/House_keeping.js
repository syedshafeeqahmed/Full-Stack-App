...
export default function House_keeping() {
...
<div class="container-fluid">
  <div class="row">
    {employee && employee.filter((item)=> item.dept === 'House Keeping').map((filtereditem)=>{return (<div class="col-6" key={filtereditem.id}>
